...
enum MenuSettings {
	...
	SETTINGMENU_RADIO_REGS = 2,
};

enum RaceSettings {
	SETTINGMENU_RADIO_INPUT = 0,
    SETTINGRACE_RADIO_MII = 1,
...
enum HostSettings {
    ...
    SETTINGHOST_ALLOW_REGS = 2,
    SETTINGHOST_SCROLL_GP_RACES = 0 + 6
};

enum OTTSettings {
    SETTINGMENU2_RADIO_FLICKER = 0,
    SETTINGMENU2_RADIO_FPS = 1,
    SETTINGMENU2_RADIO_FOV = 2,
};

enum KOSettings {
    SETTINGMENU_RADIO_DISABLEMUSIC = 0,
	SETTINGRACE_RADIO_SPEEDUP = 1,
	SETTINGRACE_RADIO_BRSTM = 2,
	SETTINGRACE_RADIO_TFRESET = 3, 
};
...
enum Menu2Settings {
	...
	SETTINGKO_ENABLED = 5,
    SETTINGKO_FINAL = 6,
	SETTINGHOST_RADIO_HOSTWINS = 7,
	SETTINGMENU2_RADIO_BLUR = 8,
...
enum MenuSettingRegs {
    MENUSETTING_REGS_DISABLED,
    MENUSETTING_REGS_ENABLED
};
...
enum RaceSettingBLUES {
    RACESETTING_BLUES_DISABLED = 0x0,
    RACESETTING_BLUES_ENABLED = 0x1
};

enum RaceSettingTF {
    RACESETTING_TFRESET_DISABLED = 0x0,
    RACESETTING_TFRESET_ENABLED = 0x1
};
